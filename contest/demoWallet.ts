...
export const deployerWallet = process.env.DEPOLYER_WALLET||'length mandate body time second act motion gallery cart hybrid second alien echo earth habit mutual like need distance dwarf wine six latin idle'
